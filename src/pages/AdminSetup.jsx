...
export default function AdminSetup() {
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      const userCred = await createUserWithEmailAndPassword(auth, 'adhil@gmail.com', 'adhil@2013');
    ...
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '80vh', padding: '24px' }}>
      <div className="card" style={{ maxWidth: '450px', width: '100%', textAlign: 'center' }}>
        ...
        <p style={{ color: 'var(--text-secondary)', marginBottom: '32px' }}>
          Click the button below to initialize the primary Super Admin account for <strong>adhil@gmail.com</strong>.
        </p>
